var page = 0;
app.controller("MoshtarySearchCtrl", function ($scope, $http, $window, $timeout, $fancyModal) {
    ...
    $scope.Srch_Moshtary = { Moshtary_Name: "", Department_id: "", Company_id: "", Price_From: "", Price_To: "", Barcode_From: "", Barcode_To: "", Taxes: "" };
    //----------------------------------------------------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------------------------------------------------
    ...
    $scope.emptyInputs = function () {
        ...
        //}
        $scope.Srch_Moshtary.Moshtary_Name = "";
    ...
    $scope.getAllRecords = function (Page) {
        ...
        $http.post("/Search/Moshtary", parameter)
    ...
    $scope.CallEditPage = function (response) {
        $window.location.href = '/Moshtary/Operation/' + response.ID;
    }
});