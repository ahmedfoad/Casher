var page = 0;
app.controller("MowridSearchCtrl", function ($scope, $http, $window, $timeout, $fancyModal) {
    ...
    $scope.Srch_Mowrid = { Mowrid_Name: "", Department_id: "", Company_id: "", Price_From: "", Price_To: "", Barcode_From: "", Barcode_To: "", Taxes: "" };
    //----------------------------------------------------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------------------------------------------------
    ...
    $scope.emptyInputs = function () {
        ...
        //}
        $scope.Srch_Mowrid.Mowrid_Name = "";
        $scope.Srch_Mowrid.Department_id = "";
        $scope.Srch_Mowrid.Company_id = "";
        $scope.Srch_Mowrid.Price_From = "";
        $scope.Srch_Mowrid.Price_To = "";
        $scope.Srch_Mowrid.Barcode_From = "";
        $scope.Srch_Mowrid.Barcode_To = "";
        $scope.Srch_Mowrid.Taxes = "";
    };
    //----------------------------------------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------------------------------------
    ...
    $scope.getAllRecords = function (Page) {
        ...
        var parameter = JSON.stringify({ 'Srch_Mowrid': $scope.Srch_Mowrid, 'page': page });
        $http.post("/Search/Mowrid", parameter)
